FUNCTION z_llm_cod_soc_spare_parts.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
**********************************************************************
* Start of RAG.
* Fetch parameters called HYBRISORDER
**********************************************************************
...
* The LLM may have identified the order but it might be formatted with spaces. Remove.
      ...
      IF hybris_order IS NOT INITIAL.
...
**********************************************************************
        IF lv_bstnk IS NOT INITIAL.
          ...
          DATA(lcl_llm) = NEW zcl_cs_hub_llm_util(  ).
          lcl_llm = NEW zcl_cs_hub_llm_util( hybris_order   = lv_bstnk
...
* If no value inside our response, set as no data.
